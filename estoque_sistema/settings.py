"""
Django settings for estoque_sistema project.
...
SECRET_KEY = 'django-insecure-19b#d59#9n3*&rd1usvr*n9al80xky_-w@f-i^xnnow5rdfx&9'
...
ROOT_URLCONF = 'estoque_sistema.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'estoque.context_processors.sidebar_context',
            ],
        },
    },
]
...
WSGI_APPLICATION = 'estoque_sistema.wsgi.application'
